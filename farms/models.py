...
class CropType(models.Model):
    ...
    PLANTATION_METHOD_CHOICES = [
        ...
        ('2_bud',           '2 Bud Method'),
        ('1_bud',           '1 Bud Method'),
        ('1_bud_SHP_Method','1 Bud (SHP Method)'),
        ('other',           'Other'),
    ]
