...
class FarmAdmin(admin.ModelAdmin):
    ...
    search_fields = ('farm_owner__username', 'farm_uid', 'address')
    ...
    fieldsets = (
        ...
        ('Metadata', {
            'fields': ('farm_uid', 'created_at', 'updated_at'),
            'classes': ('collapse',),
        }),
    )
...
class PlotAdmin(LeafletGeoAdmin):
    ...
    list_filter = ('village', 'taluka', 'district', 'state', 'country')
    search_fields = ('gat_number', 'plot_number')
...
class FarmIrrigationAdmin(LeafletGeoAdmin):
    list_display = ('farm', 'irrigation_type', 'installation_date', 'status')
    list_filter = ('farm', 'irrigation_type', 'status', 'installation_date')
